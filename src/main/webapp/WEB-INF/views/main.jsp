    ...
    <div class="main-search-box-container">
      <div class="search-box-wrapper">
        <div class="search-box-search-btn">
          <img src="${pageContext.request.contextPath}/resources/images/search_y.png" alt="searh"/>
        </div>
        <div class="search-box-query-box">
          <input type="text" class="search-query" placeholder="학원을 검색해보세요">
        </div>
        <div class="search-box-cancel-btn">
          <img src="${pageContext.request.contextPath}/resources/images/close_y.png" alt="cancel"/>
        </div>
      </div>
    </div>
        ...
        <div class="d-recent-academy-wrapper d-recent-academy">
          <div class="list-header">
            ...
            <span class="reload-btn">
              <img src="${pageContext.request.contextPath}/resources/images/refresh_b.png"  width="20px" height="20px" align="bottom" "searh"/>
            </span>
          </div>
